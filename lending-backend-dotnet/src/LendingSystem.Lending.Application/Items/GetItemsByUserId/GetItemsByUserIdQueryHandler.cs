...
internal sealed class GetItemsByUserIdQueryHandler(IItemRepository items) : IRequestHandler<GetItemsByUserIdQuery, Result<IReadOnlyCollection<GetItemsByUserIdResult>>>
{
