...
public sealed record GetUserActiveLoansItemResult(
...
public sealed record GetUserActiveLoansResult(
    ...
    [property: JsonPropertyName("items")] IReadOnlyCollection<GetUserActiveLoansItemResult> Items);
