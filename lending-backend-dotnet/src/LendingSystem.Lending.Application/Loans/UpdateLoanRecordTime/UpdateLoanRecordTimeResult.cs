...
public sealed record UpdateLoanRecordTimeItemResult(
...
public sealed record UpdateLoanRecordTimeResult(
    ...
    [property: JsonPropertyName("items")] IReadOnlyCollection<UpdateLoanRecordTimeItemResult> Items)
{
