...
namespace LendingSystem.SharedKernel.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260601055249_ExtractUserAuthIdentities")]
    partial class ExtractUserAuthIdentities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LendingSystem.SharedKernel.Infrastructure.Persistence.UserAuthIdentityEntity", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("user_auth_identities_pkey");

                    b.HasIndex("UserId")
                        .HasDatabaseName("idx_user_auth_identities_user_id");
