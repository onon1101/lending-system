...
public static class LoanRepositoryErrors
{
    ...
    public static RepositoryErrors ItemUnavailableOrNotFound(long itemId) =>
    ...
    public static RepositoryErrors ItemNotFound(long itemId) =>
        new("LOAN_ITEM_NOT_FOUND", $"物品 ID {itemId} 不存在", "Item not found", ErrorType.NotFound);

    public static RepositoryErrors ItemDoesNotBelongToOwner(long itemId, long ownerId) =>
    ...
    public static RepositoryErrors LoanRecordNotFound(long orderId) =>
        new("LOAN_RECORD_NOT_FOUND", $"借閱紀錄 ID {orderId} 不存在", "Loan record not found", ErrorType.NotFound);

    public static RepositoryErrors LoanRecordDoesNotBelongToOwner(long orderId, long ownerId) =>
    ...
    public static RepositoryErrors LoanItemAlreadyReturnedOrNotFound(long orderId, long itemId) =>
    ...
    public static RepositoryErrors BorrowerNotFound(long borrowerId) =>
